...
router.get("/:curpage", function(req, res){
  ...
  var querystring = 'select count(*) as cnt from sensor6;'
  ...
  client.query(querystring, function(error2, data){
    ...
    fs.readFile('views/sensor/sensor6.ejs', 'utf-8', function (error, data) {
    ...
    var queryString = 'select * from sensor6 order by id desc limit ?,?';
