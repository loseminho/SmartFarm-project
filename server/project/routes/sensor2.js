...
router.get("/:curpage", function(req, res){
  ...
  var querystring = 'select count(*) as cnt from sensor2;'
  ...
  client.query(querystring, function(error2, data){
    ...
    fs.readFile('views/sensor/sensor2.ejs', 'utf-8', function (error, data) {
    ...
    var queryString = "SELECT id, sensor, DATA, date_format(TIME,'%Y-%m-%d %H:%i:%s')  as time from sensor2";
